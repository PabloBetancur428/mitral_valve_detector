...
def main():
    ...
    # For debugging
    train_annotations = train_annotations.sample(frac=0.01, random_state=42).reset_index(drop=True)
    val_annotations = val_annotations.sample(frac=0.01, random_state=42).reset_index(drop=True) 
