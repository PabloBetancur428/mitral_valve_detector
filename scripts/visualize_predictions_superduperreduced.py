...
def draw_gt_vs_pred(
    ...
    ax_panel.set_facecolor("#5f967615")  # soft dark gray
...
def main(view = None, num_samples = 10):
    ...
    annotations_path = Path(
        rf"e:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\data\processed_cone_dataset_prop_aSaco\split_augmented_3_5\reduced_labels\2_labels\original_val_superduperreduced.csv"
    )
    ...
    # For loading the correct weights
    checkpoint_path = rf"e:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\experiments_after_vacations\sgd_lr0.01_bs4_cosine_3classes_3warmup_7constant_cosine_140426_augs05\checkpoints\best_val_loss.pth"
