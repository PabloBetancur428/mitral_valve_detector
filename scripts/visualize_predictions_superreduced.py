...
def main(view = None, num_samples = 10):
    ...
    annotations_path = Path(
        rf"e:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\data\processed_cone_dataset_prop_aSaco\split_augmented_3_5\reduced_labels\original_val_superreduced_label.csv"
    )
    ...
    checkpoint_path = rf"E:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\experiments_after_vacations\sgd_lr0.01_bs4_cosine_4classes_again\checkpoints\best_label_precision.pth"
