...
def main():
    ...
    # -------- PATHS (EDIT) --------
    annotations_path = Path(rf"e:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\data\processed_cone_dataset_prop_aSaco\split_augmented_3_5\val_3_5_split_reduced_labels.csv")
    ...
    checkpoint_path = Path(rf"E:\Z2455862L\Desktop\Random_Programming\mitral_valve_det\mitral_valve_detector\experiments\best_models_new_augs_7k_3103_highLR\best_match_precision.pth")
